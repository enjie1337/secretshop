          ...
          <div className="row">
            <div className="col-xl-6 col-lg-12 col-md-12">
              <div className="item-media">
                <div className="media">
                  <img src={imgdetail1} alt="Metagates" />
                </div>
              ...
              <div className="content-item">
                ...
                <div className="author-item">
                  <div className="avatar">
                    <img src={avt1} alt="Metagates" />
                  </div>
                  <div className="infor">
                    <div className="create">Owner By</div>
                    <h6>
                      <Link to="/authors">Duane M. Mendoza</Link>{" "}
                    </h6>
                ...
                <div className="author-bid">
                  <div className="author-item">
                    <div className="avatar">
                      <img src={avt2} alt="Metagates" />
                    </div>
                    <div className="infor">
                      <h6>
                        <Link to="/authors">Metagates</Link>{" "}
                      </h6>
                  ...
                  <div className="author-item">
                    <div className="avatar">
                      <img src={avt3} alt="Metagates" />
                    </div>
                    <div className="infor">
                      <h6>
                        <Link to="/authors">David Stein</Link>{" "}
                      </h6>
                        ...
                        {dataHistory.map((item, index) => (
                          <li key={index}>
                            <div className="content">
                              <div className="author-item">
                                <div className="avatar">
                                  <img src={item.img} alt="Metagates" />
                                </div>
                                <div className="infor">
                                  <p>
                                    Bid listed for{" "}
