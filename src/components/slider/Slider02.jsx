            ...
            <div className="slider-inner flex home-1 style-2">
              ...
              <div className="slider-img flex">
                <div className="img-left">
                  <div className="img-1">
                    <img src={props.item.img1} alt="Metagates" />
                  </div>
                  <div className="img-2">
                    <img src={props.item.img2} alt="Metagates" />
                  </div>
                </div>
                <div className="img-right">
                  ...
                  <div className="box-avatar flex">
                    <div className="list-avatar flex">
                      <img src={props.item.avt1} alt="Metagates" />
                      <img src={props.item.avt2} alt="Metagates" />
                      <img src={props.item.avt3} alt="Metagates" />
                      <img src={props.item.avt4} alt="Metagates" />
                    </div>
